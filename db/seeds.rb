...
Be sure you can better your condition before you seek to change.", difficulty: "easy")

prompt2 = Prompt.create(content: "There was once a Countryman who possessed the most wonderful Goose you can imagine, for every day when he visited the nest, the Goose had laid a beautiful, glittering, golden egg.

The Countryman took the eggs to market and soon began to get rich. But it was not long before he grew impatient with the Goose because she gave him only a single golden egg a day. He was not getting rich fast enough.

Then one day, after he had finished counting his money, the idea came to him that he could get all the golden eggs at once by killing the Goose and cutting it open. But when the deed was done, not a single golden egg did he find, and his precious Goose was dead.

Those who have plenty want more and so lose all they have.", difficulty: "easy")

prompt3 = Prompt.create(content: "And when the party entered the assembly room it consisted only of five all together, – Mr. Bingley, his two sisters, the husband of the eldest, and another young man.
...
Elizabeth Bennet had been obliged, by the scarcity of gentlemen, to sit down for two dances; and during part of that time, Mr. Darcy had been standing near enough for her to overhear a conversation between him and Mr. Bingley, who came from the dance for a few minutes, to press his friend to join in.", difficulty: "medium")

prompt4 = Prompt.create(content: "In a hole in the ground there lived a hobbit. Not a nasty, dirty, wet hole, filled with the ends of worms and an oozy smell, nor yet a dry, bare sandy hole with nothing in it to sit down on or eat: it was a hobbit-hole, and that means comfort.
...
This hobbit was a very well-to-do hobbit, and his name was Baggins. The Baggins had lived in the neighbourhood of The Hill for time out of mind.", difficulty: "medium")

prompt5 = Prompt.create(content: "Fans, for the past two weeks you have been reading about a bad break I got. Yet today I consider myself the luckiest man on the face of the earth. I have been in ballparks for seventeen years and have never received anything but kindness and encouragement from you fans.
...
So I close in saying that I might have had a tough break – but I have an awful lot to live for!", difficulty: "difficult")

prompt6 = Prompt.create(content: "I would like to thank the Secretary General for inviting me to be part of this important United Nations Fourth World Conference on Women. This is truly a celebration, a celebration of the contributions women make in every aspect of life: in the home, on the job, in the community, as mothers, wives, sisters, daughters, learners, workers, citizens, and leaders.
